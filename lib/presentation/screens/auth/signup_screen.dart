...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _handleSignup() async {
    ...
    final String? genderIsValid = ValidationService.validateGender(_selectedGender);
    ...
    final success=await signupUseCase(
      RegisterData(
        ...
        gender:_selectedGender!, // Si on arrive ici c'est que le selectedGender n'est pas null !
    ...
    if(success){
      context.go('/login', extra: 'Inscription réussie, vous pouvez vous connecter !');
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
      ...
      body:Padding(
        ...
        child:Column(children:[
          CustomFormField(
            ...
            validator: (value) => ValidationService.validateName('username', value),
          ...
          CustomFormField(
            ...
            label:'Nom',
            validator: (value) => ValidationService.validateName('nom de famille', value),
            inputType: TextInputType.text,
          ),
            CustomFormField(
          ...
          TextButton(
              ...
              child: const Text('Vous avez déjà un compte ? Connectez-vous ici !')),
        ]),
      ),
    );
  }
